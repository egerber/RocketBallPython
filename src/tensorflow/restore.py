...
gradients=optimizer.compute_gradients(rmse,[val])
saver=tf.train.Saver()


sess=tf.Session()

saver.restore(sess,"/home/emanuel/Coding/tensorflow/SessionData/sessLSTMPeep.chkpt")

input_=[inputs[0],inputs[1]]
output_=[outputs[0],outputs[1]]
